...
class TTRBot:
    ...
    def click_next_target(self):
        ...
        #   3. confirm that it's speedchat via the tooltip
        ...
        target_i = 0
        found_target = False
        while not found_target and target_i < len(targets):
    ...
    def confirm_tooltip(self, target_position):
        ...
        if max_val >= self.TOOLTIP_MATCH_THRESHOLD:
            ...
            # the offset [he] always got was Offset calculated as x: -22 y: -29
            return True
